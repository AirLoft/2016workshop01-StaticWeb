...
var S = {
  init: function () {
    ...
    S.UI.simulate('#countdown 10|(❁´◡`❁)|Hello ADA|');
    }
...
S.UI = (function () {
  ...
  function performAction(value) {
    ...
    timedAction(function () {
      ...
      case 'icon':
        S.ShapeBuilder.imageFile('https://github.com/kennethcachia/shape-shifter/blob/master/release/font-awesome/' + value + '.png', function (obj) {
